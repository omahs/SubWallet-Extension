...
import { MultiChainSwapPair, SwapPair, SwapQuoteResponse, SwapRequest, SwapRequestResult, SwapSubmitParams, ValidateSwapProcessParams } from '@subwallet/extension-base/types/swap';
...
export default class KoniExtension {
  ...
  private async subscribeMultiChainSwapPairs (id: string, port: chrome.runtime.Port): Promise<MultiChainSwapPair[]> {
    const cb = createSubscription<'pri(swapService.subscribeMultiChainPairs)'>(id, port);
    let ready = false;
    ...
    const subscription = this.#koniState.swapService.subscribeMultiChainSwapPairs(callback);
    ...
    return this.#koniState.swapService.getMultiChainSwapPairs();
  }
  ...
  public async handle<TMessageType extends MessageTypes> (id: string, type: TMessageType, request: RequestTypes[TMessageType], port: chrome.runtime.Port): Promise<ResponseType<TMessageType>> {
    ...
    switch (type) {
      ...
      case 'pri(database.exportJson)':
        ...
        /* Swap service */
      case 'pri(swapService.subscribeMultiChainPairs)':
        return this.subscribeMultiChainSwapPairs(id, port);
