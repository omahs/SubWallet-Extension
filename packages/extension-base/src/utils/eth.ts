...
import { EvmEIP1995FeeOption, EvmFeeInfo, FeeOption } from '@subwallet/extension-base/types';
...
export const combineEthFee = (feeInfo: EvmFeeInfo, feeOptions?: FeeOption, feeCustom?: EvmEIP1995FeeOption): EvmFeeCombine => {
