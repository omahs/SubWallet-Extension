...
export const DataContextProvider = ({ children }: DataContextProviderProps) => {
  ...
  // Swap
  _DataContext.addHandler({ ...subscribeMultiChainSwapPairs, name: 'subscribeMultiChainSwapPairs', relatedStores: ['swap'] });
