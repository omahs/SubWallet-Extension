...
export const BLOCK_STAKING_SET_CLAIM_PERMISSIONLESS: string[] = ['substrate'];
...
export const BLOCK_ACTION_LEDGER_NETWORKS: Record<ExtrinsicType, string[]> = {
  ...
  [ExtrinsicType.STAKING_SET_CLAIM_PERMISSIONLESS]: BLOCK_STAKING_SET_CLAIM_PERMISSIONLESS,
